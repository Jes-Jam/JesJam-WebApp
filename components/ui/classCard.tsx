...
function ClassCard({ currentClass, isPending, updatingClassId, isEnrolled, onClick, isHoveringActive, isHoveringEnrolled, activeClassId, setIsHoveringActive, setIsHoveringEnrolled  }: ClassCardProps) {
  return (
